...
public class TransactionControllerTest {
	...
	public void initTransactionControllerTest(CreateTransactionRequest ctRequest, FindAllTransactionsByUserRequest fatbuRequest) {
	...
	public void createTransaction(CreateTransactionRequest ctRequest, FindAllTransactionsByUserRequest fatbuRequest) throws Exception {
		initTransactionControllerTest(ctRequest, fatbuRequest);
