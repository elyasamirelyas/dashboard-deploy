...
public class UserControllerTest {
	...
	public void initUserControllerTest(CreateUserRequest request) {
	...
	public void createUser(CreateUserRequest request) throws Exception {
		...
		initUserControllerTest(request);
	...
	@MethodSource("data")
	@ParameterizedTest
	public void findAll(CreateUserRequest request) throws Exception {
